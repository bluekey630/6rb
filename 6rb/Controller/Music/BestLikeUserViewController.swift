//
//  BestLikeUserViewController.swift
//  6rb
//
...
class BestLikeUserViewController: UIViewController {
    ...
    func getLikeUsers() {
        APIManager.shared.getBestLikeUsers(more: true, date: date, completion: {
            error, response in
            if error != nil {
...
extension BestLikeUserViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        return 90
    }
}

extension BestLikeUserViewController: UITableViewDataSource {
...
extension BestLikeUserViewController: UITextFieldDelegate {
